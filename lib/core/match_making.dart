...
class MatchMaker extends ChangeNotifier {
  ...
  Future<bool> dateExist(String id) async {
    CollectionReference ref = FirebaseFirestore.instance.collection("dates");
  ...
  void match(String uid, String dateId) {
    var id = getId(uid, dateId);
    dateExist(id).then((value) {
      CollectionReference ref = FirebaseFirestore.instance.collection("dates");
  ...
  void unmatch(String uid, String dateId) {
    var id = getId(uid, dateId);
    CollectionReference ref = FirebaseFirestore.instance.collection("dates");
    ref.doc(id).update({
      uid: false
  ...
  Future<List<Users>> fetchMatches(String uid) async {
